    ...
    <view class="container">
        ...
        <view class="agreement-content">
            ...
            <view class="section">
                ...
                <view class="section-content">
                    <view class="subsection">
                        <text class="bold">1. 您提供的信息：</text>
                        <text>当您使用我们的服务时，您可能会向我们提供相关信息，如联系方式、个人资料等。</text>
                    </view>
                    <view class="subsection">
                        <text class="bold">2. 我们获取的信息：</text>
                        <text>在您使用服务过程中，我们可能会收集相关信息以优化服务体验，包括设备信息、使用日志等。</text>
                    </view>
                </view>
            </view>
            ...
            <view class="section">
                ...
                <view class="section-content">
                    <view class="permission-item">
                        ...
                        <text>当您使用扫码功能时，我们需要访问您的摄像头权限以识别二维码信息。我们不会存储或传输任何视频或图像内容。</text>
                    </view>
                    <view class="permission-item">
            ...
            <view class="section">
                ...
                <view class="section-content">
                    <text>如您对本政策或个人信息保护有任何疑问，可通过客服渠道联系我们。</text>
                </view>
            </view>
        </view>
    </view>
